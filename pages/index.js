    ...
    <div className="h-100 d-flex align-items-center justify-content-center flex-column">
      ...
      <form>
        ...
        <div className="mb-3">
          ...
          <button type="button" className="btn btn-secondary btn-sm ms-4 px-4">
            -
          </button>
        ...
        <div className="mb-3">
          ...
          <button type="button" className="btn btn-secondary btn-sm px-4  mx-1">
            Magic
          </button>
        </div>
        <div className="form-floating mb-3">
          <input
            ...
            placeholder="name@example.com"
          />
          <label for="floatingInput">Type Car Name for any Specific Type</label>
        </div>
        <div className="form-floating mb-3">
          <input
            type="email"
